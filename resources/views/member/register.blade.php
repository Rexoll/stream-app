                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{route('member.register.store')}}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your complete name" />
                                @error('name')
                                    <div style="color:red">
                                    {{$message}}
                                    </div>
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="email" name="email" value="{{old('email')}}" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your email address" />
                                @error('email')
                                    <div style="color:red">
                                    {{$message}}
                                    </div>
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text" name="phone_number" value="{{old('phone_number')}}" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your phone number" />
                                @error('phone_number')
                                    <div style="color:red">
                                    {{$message}}
                                    </div>
                            ...
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="password" name="password" value="{{old('password')}}" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline-stream-gray outline outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your password" />
                                @error('password')
                                    <div style="color:red">
                                    {{$message}}
                                    </div>
